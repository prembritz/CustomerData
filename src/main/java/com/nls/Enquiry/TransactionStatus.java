...
public class TransactionStatus {
	...
	public static void setInitiailizeChannelGlobalParameters(HashMap<String, String> GlobalParameters) {
	...
	@APIResponseSchema(value = TransactionStatusObject.class, responseDescription = "Transaction Status Response", responseCode = "200")
